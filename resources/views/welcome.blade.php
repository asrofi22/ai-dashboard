<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark" x-data="{ sidebarOpen: true, activeTab: 'dashboard' }">
    <head>
        <meta charset="utf-8">
        ...
        <div class="flex-1 flex flex-col h-screen overflow-hidden relative">
            ...
            <header class="h-16 bg-white/80 dark:bg-[#12151E]/80 backdrop-blur-md border-b border-slate-200 dark:border-[#222735] flex items-center justify-between px-4 sm:px-6 z-10 shrink-0">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <button onclick="document.documentElement.classList.toggle('dark')" class="p-2 rounded-full text-slate-500 hover:bg-slate-100 dark:hover:bg-[#1C212E] dark:text-slate-400 transition-colors">
